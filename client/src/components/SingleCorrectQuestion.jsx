...
export default function SingleCorrectQuestion(props) {
  ...
  const handleCheckboxChange = (event) => {
    ...
    setQuestionData({
      ...
      option1:
        name === "option1"
          ? { ...questionData.option1, isCorrect: checked }
          : { ...questionData.option1, isCorrect: false },
      option2:
        name === "option2"
          ? { ...questionData.option2, isCorrect: checked }
          : { ...questionData.option2, isCorrect: false },
      option3:
        name === "option3"
          ? { ...questionData.option3, isCorrect: checked }
          : { ...questionData.option3, isCorrect: false },
      option4:
        name === "option4"
          ? { ...questionData.option4, isCorrect: checked }
          : { ...questionData.option4, isCorrect: false },
    });
  };
